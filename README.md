...
View the [sample copy spreadsheet](https://docs.google.com/spreadsheet/pub?key=1OmB_lCYuVSLVs46LOhiEGdJxVJRg7oioK0SC-dcmtC8#gid=0).
...
def read_my_google_doc():
    ...
    get_document('1OmB_lCYuVSLVs46LOhiEGdJxVJRg7oioK0SC-dcmtC8', file_path)
    data = Copy(file_path)
...
```
* * * * * ubuntu bash /home/ubuntu/apps/stl100_2016/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
...
|--------|------|-----|-----|
|stl100-2016|tweet|`location`||
|stl100-2016|facebook|`location`||
|stl100-2016|email|`location`||
|stl100-2016|new-comment||
|stl100-2016|open-share-discuss||
|stl100-2016|close-share-discuss||
|stl100-2016|summary-copied||
|stl100-2016|featured-tweet-action|`action`|
|stl100-2016|featured-facebook-action|`action`|
